...
const UploadSection = () => {
    ...
    const handleWhatsApp = () => {
        const text = `Hello Dolfin Zerox! I'd like to place an order.
...
Details: ${numPages} Pages, ${copies} Copies, ${pageSize}, ${colorMode}, ${printSide}`;
    ...
    const handleEmail = () => {
        const subject = `Order Inquiry from Dolfin Zerox Website`;
        const body = `Hello Dolfin Zerox Team,
...
`;
        window.location.href = `mailto:dolfinzerox2@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    };
